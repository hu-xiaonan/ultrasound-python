...
if __name__ == '__main__':
    ...
    p = [
        get_p_f(ula, props, medium, tx_delays_planar, tx_apodization_rect, points, freq),
        get_p_f(ula, props, medium, tx_delays_planar, tx_apodization_hanning, points, freq),
        get_p_f(ula, props, medium, tx_delays_focused, tx_apodization_rect, points, freq),
        get_p_f(ula, props, medium, tx_delays_focused, tx_apodization_hanning, points, freq),
    ]
    ...
    fig.savefig('fig-S4-apodization.png', dpi=300)
