...
if __name__ == '__main__':
    ...
    tx_delays_arr = np.load('data-0-tx_delays.npy')
    signals_rx_t_arr = np.load('data-0-signals.npy')
    ...
    echo_img = log_compress(echo_img, dynamic_range=60, uint8=True)
    ...
    fig.savefig('fig-0-concept.png', dpi=300)
    Image.fromarray(echo_img).save('fig-0-logo.png')
